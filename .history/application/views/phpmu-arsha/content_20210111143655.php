						...
						<div class='container-fluid' data-aos='fade-up'>
							<div class='d-flex flex-column justify-content-center'>
								<div class='accordion-list mt-3'>
									<ul>
										<li>
											<a data-toggle='collapse' class='collapse' href='#accordion-list-1'><span style="color:orangered">01</span> Mahabbah - محبة <i class='bx bx-chevron-down icon-show'></i><i class='bx bx-chevron-up icon-close'></i></a>
					...
					?>
						<div class="card mb-3">
							<div class="card-body ">
								...
								<h6 class="card-subtitle mb-2 text-muted" style="font-size:16px;">
									<?php
									echo "<a href='" . base_url() . "kategori/detail/$row[kategori_seo]' style='color:orange !important'><b>$row[nama_kategori]</b></a>
										<a href='" . base_url() . "$row[judul_seo]' style='font-family:inherit; font-size:14px !important'>$row[jam], " . tgl_indo($row['tanggal']) . "</a>";
									?>
								</h6>
								...
								?>
									<div class="row row-striped">
										...
										<div class="col-10 mt-2">
											<h2 style="margin-bottom:5px; font-family:inherit; font-size:20px !important"><strong><a href="<?php echo base_url(); ?>agenda/detail/<?php echo $r['tema_seo']  ?>"><?php echo $judull; ?></a></strong></h2>
